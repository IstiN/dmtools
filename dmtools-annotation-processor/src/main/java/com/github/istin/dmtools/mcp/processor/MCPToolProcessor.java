...
public class MCPToolProcessor extends AbstractProcessor {
    ...
    private void generateParameterConversionMethod(PrintWriter out) {
        ...
        out.println("        }");
        out.println();
        out.println("        // Check for String passed when String[] expected - provide helpful error");
        out.println("        if (targetType.equals(\"java.lang.String[]\") && value instanceof String) {");
        out.println("            throw new IllegalArgumentException(");
        out.println("                \"Parameter '\" + paramName + \"' must be an array.\\n\" +");
        out.println("                \"Expected: [\\\"value1\\\", \\\"value2\\\"]\\n\" +");
        ...
        out.println("        }");
        out.println();
        out.println("        // Check for String passed when Object[] expected - provide helpful error");
        out.println("        if (targetType.equals(\"java.lang.Object[]\") && value instanceof String) {");
        out.println("            throw new IllegalArgumentException(");
        out.println("                \"Parameter '\" + paramName + \"' must be an array.\\n\" +");
        out.println("                \"Expected: [\\\"value1\\\", \\\"value2\\\"]\\n\" +");
        out.println("                \"Received: \\\"\" + value + \"\\\"\"");
        ...
        out.println("            throw new IllegalArgumentException(");
        out.println("                \"Parameter '\" + paramName + \"' has incorrect type.\\n\" +");
        out.println("                \"Expected: \" + targetType + \"\\n\" +");
        out.println("                \"Received: \" + value.getClass().getSimpleName()");
        out.println("            );");
        out.println("        }");
        out.println("    }");
        out.println();
